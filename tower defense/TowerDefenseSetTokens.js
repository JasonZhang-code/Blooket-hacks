(async () => {
    ...
    o.setState({ crypto: e, crypto2: e });
    o.props.liveGameController.setVal({
        path: "c/".concat(o.props.client.name);
        val: { b: o.props.client.blook, p: o.state.password, cr: e }
    }))
})();